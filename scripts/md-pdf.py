...
def inline(text: str) -> str:
    ...
    # как отступом). Возвращаем только синтаксически валидные сущности и
    # только вне кода (он уже спрятан в stash и печатается буквально);
    # одиночный "&" в тексте и в URL остается экранированным.
    s = re.sub(r"&amp;(#\d{1,7}|#[xX][0-9a-fA-F]{1,6}|[A-Za-z][A-Za-z0-9]{1,31});", r"&\1;", s)
