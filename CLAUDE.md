...
Дисциплина разбора - по скиллу `codex-audit`: каждую находку верифицировать самостоятельно, ложные тревоги отклонять с обоснованием, на каждую подтвержденную кодовую находку - регресс-тест. После фиксов по находкам предложить re-review диффа фиксов (`codex exec resume`) - фиксы тонких мест сами порождают дефекты.
