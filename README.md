...
**24 правила · 13 агентов · 15 скиллов · 5 типов проектов · 138 тестов движка · раскатка по HTTP, идемпотентная и обратимая**
...
- **management** - управленческие проекты, планирование: агент `tracker`, правила встреч/задач/оценок, сверки имен и биллинга AI-работы, скиллы зеркалирования внешних источников (`telegram-snapshot`, `redmine-snapshot`, `mymeet-snapshot`), отправки в Telegram, локальной транскрипции и калибровочной оценки трудоемкости (`estimate-calibration`).
...
3. **[`tests/`](./tests/)** - 138 stdlib-тестов, включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
...
- `rules/` - канонические правила поведения Claude (24).
