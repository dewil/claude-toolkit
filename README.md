...
**28 правил · 14 агентов · 17 скиллов · 5 типов проектов · 270 тестов · раскатка по HTTP, идемпотентная и обратимая**
...
- **management** - управленческие проекты, планирование: агент `tracker`, правила встреч/задач/оценок, сверки имен и биллинга AI-работы, скиллы зеркалирования внешних источников (`telegram-snapshot`, `redmine-snapshot`, `mymeet-snapshot`), отправки в Telegram, чтения ленты комментариев Asana в обход потолка MCP (`asana-comments`), локальной транскрипции и калибровочной оценки трудоемкости (`estimate-calibration`).
...
3. **[`tests/`](./tests/)** - 270 stdlib-тестов (100 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
...
- `skills/` - канонические скиллы, папка на скилл (17).
