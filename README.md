...
**27 правил · 14 агентов · 17 скиллов · 5 типов проектов · 232 теста · раскатка по HTTP, идемпотентная и обратимая**
...
3. **[`tests/`](./tests/)** - 232 stdlib-теста (100 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
