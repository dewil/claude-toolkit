...
**28 правил · 14 агентов · 18 скиллов · 5 типов проектов · 299 тестов · раскатка по HTTP, идемпотентная и обратимая**
...
3. **[`tests/`](./tests/)** - 299 stdlib-тестов (100 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
...
- `rules/` - канонические правила поведения Claude (28).
- `agents/` - канонические описания субагентов (14).
- `skills/` - канонические скиллы, папка на скилл (18).
