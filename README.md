...
**27 правил · 14 агентов · 16 скиллов · 5 типов проектов · 174 теста · раскатка по HTTP, идемпотентная и обратимая**
...
3. **[`tests/`](./tests/)** - 164 stdlib-теста (100 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
...
- `skills/` - канонические скиллы, папка на скилл (16).
