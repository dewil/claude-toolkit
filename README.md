...
**39 правил · 14 агентов · 26 скиллов · 5 типов проектов · 737 тестов · раскатка по HTTP, идемпотентная и обратимая**
...
3. **[`tests/`](./tests/)** - 737 stdlib-тестов (110 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
...
- `rules/` - канонические правила поведения Claude (39).
