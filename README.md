...
**29 правил · 14 агентов · 22 скилла · 5 типов проектов · 377 тестов · раскатка по HTTP, идемпотентная и обратимая**
...
- **coding** - кодовые проекты любого стека: правила тестов и обработки ошибок, агенты `debugger`, `implementer`, `code-reviewer`, скиллы `minimal-code`, `requirements` (сбор размытых требований в ТЗ до кода), `qa-browser`.
...
- `rules/` - канонические правила поведения Claude (29).
- `agents/` - канонические описания субагентов (14).
- `skills/` - канонические скиллы, папка на скилл (22).
