...
**35 правил · 14 агентов · 25 скиллов · 5 типов проектов · 539 тестов · раскатка по HTTP, идемпотентная и обратимая**
...
3. **[`tests/`](./tests/)** - 539 stdlib-тестов (100 из них - движок), включая crash-матрицу WAL и по регресс-тесту на каждую находку состязательного ревью. Инварианты движка быстрее всего считываются именно отсюда.
