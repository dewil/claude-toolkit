...
- **Оценка не нужна как артефакт** - вопрос "сколько примерно займет" внутри рабочего разговора отвечается прикидкой в одну строку, без якорей и рубрики. Скилл для оценки, которую придется защищать.
- **Работа уже идет и оценена** - пересчет по ходу это не калибровка, а смена скоупа; сначала фиксируется, что изменилось.
- **Вопрос про деньги, а не про трудоемкость** - ставка, скидка, что выставлять клиенту за работу агента: это `billing-ai-work.md`. Скилл считает часы, а не рубли.
- **Нет ни одного факта о прошлых работах** - без якорей рубрика превращается в угадывание с видом точности. Тогда честнее дать вилку и назвать ее вилкой.
