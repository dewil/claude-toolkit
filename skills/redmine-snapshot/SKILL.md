...
4. **Снапшот - технический артефакт: в синкаемой папке исключить его из синка.** Механика и оговорки - `rules/docs-maintenance.md`, раздел "Технические артефакты в синкаемой папке".
